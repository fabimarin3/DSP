...
t1=0:2;%Defino t2 para que sea de 0 a 2, este va  en pasos de 1
...
xlabel('Tiempo');
ylabel('x1(t)');
title('Coseno en función del tiempo');

subplot(2,1,2); 
n1=stem(x2,'r');%Discretizo y grafico la función x3
xlabel('Muestras');
ylabel('x2(n)');
title('Coseno discretizado');
